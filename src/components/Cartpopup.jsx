              ...
              <div class="fixcl-scroll-content">
                ...
                <div class="mini_cart_items js_cat_items lazyload">
                  {cartItem?.map((item, index) => {
                    return (
                      <div
                        key={index}
                        class="mini_cart_item js_cart_item flex al_center pr oh"
                      >
                ...
                {/* <div class="mini_cart_tool js_cart_tool tc ">
                  ...
                  >
                    ...
                    <span class="tt_txt">Add A Gift Wrap</span>
                  </div>
                  <div
                    data-id="ship"
                    class="mini_cart_tool_ship js_cart_tls ttip_nt tooltip_top"
                  >
                    <i class="las la-truck-moving"></i>
                    <span class="tt_txt">Estimate Shipping</span>
                  </div>
                  <div
                    data-id="dis"
                    class="mini_cart_tool_dis js_cart_tls ttip_nt tooltip_top"
                  >
            ...
            <div class="shipping_calculator tc">
              <p class="field">
                ...
                <span class="gift_wrap_text mt__10 db">
                  <span class="cd">Do you want a gift wrap?</span> Only Rs. 5.00
                </span>
              </p>
              <p class="field">
                <a
                  href="shop-filter-sidebar.html"
                  class="w__100 tu tc button button_primary truncate js_addtc"
                >
                  Add A Gift Wrap
                </a>
              </p>
              <p class="field">
                <input
                  type="button"
                  class="button btn_back js_cart_tls_back"
                  value="Cancel"
                />
              </p>
            </div>
