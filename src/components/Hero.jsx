  ...
  return (
    <div className="kalles-section nt_section type_slideshow type_carousel kalles-cosmetics__main-slide">
      <div className="kalles-cosmetics__main-slide nt_full se_height_cus_h nt_first">
        ...
        >
          <div className="col-12 slideshow__slide kalles-cosmetics__main-slide__layout-01">
            <div className="oh pr nt_img_txt bg-transparent">
              <div className="js_full_ht4 img_slider_block dek_img_slide">
                <div
                  ...
                  data-bgset="assets/images/home-cosmetics/main-slide-01.jpg"
                ></div>
              </div>
              ...
              <div className="caption-wrap caption-w-1 pe_none z_100 tl_md tc">
                <div className="pa_txts caption">
                  <div className="left_right">
                    ...
                    <div className="slt4_space kalles-cosmetics__main-slide-01__br-01"></div>
          ...
          <div className="col-12 slideshow__slide kalles-cosmetics__main-slide__layout-02">
            <div className="oh pr nt_img_txt bg-transparent">
              <div className="js_full_ht4 img_slider_block dek_img_slide">
                <div
                  className="bg_rp_norepeat bg_sz_cover lazyload item__position center center img_zoom pa l__0 t__0 r__0 b__0"
                  data-bgset="assets/images/home-cosmetics/main-slide-02.jpg"
                ></div>
              </div>
              <div className="js_full_ht4 img_slider_block mb_img_slide">
                <div
              ...
              <div className="caption-wrap caption-w-1 pe_none z_100 tc_md tc">
                <div className="pa_txts caption">
                  <div className="right_left">
                    <h4 className="slt4_h4 mg__0 lh__1 f_body kalles-cosmetics__main-slide-02__subtitle">
                      NEW COLLECTION
                    </h4>
                    <div className="slt4_space kalles-cosmetics__main-slide-02__br-01"></div>
                    <h3 className="slt4_h3 lh__1 mg__0 kalles-cosmetics__main-slide-02__title">
                      UV Protection Cream
                    </h3>
                    <div className="slt4_space kalles-cosmetics__main-slide-02__br-02"></div>
                    <a
                      className="slt4_btn button pe_auto round_false btn_icon_false kalles-cosmetics__main-slide-02__btn"
                      href="#"
                    >
                      SHOP NOW
                    </a>
